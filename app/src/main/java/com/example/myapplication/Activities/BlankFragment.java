 ...
 */
public class ShowListFragment extends ListFragment implements SearchView.OnQueryTextListener, ListHandler {
    ...
    public boolean onQueryTextSubmit(String query) {
        new ShowList(this).executeOnExecutor(ShowList.THREAD_POOL_EXECUTOR, query);
        return false;
    }
    ...
    @Override
    public void handleList(ShowList results) {
        adapter.clear();
